                        ...
                        <div class="abc scroll" style="height: 250px;padding: 0;margin: 0;">
                            <table width="85%" class="sub-table scrolldown" border="0">
                                ...
                                <tbody>
                                    ...
                                    $sqlmain = "select * from schedule a inner join appointment b on a.scheduleid=b.scheduleid inner join patient c on c.pid=b.pid inner join doctor d on a.docid=d.docid where c.pid=$userid and a.scheduledate>='$today' order by a.scheduledate asc";
                                    echo $sqlmain;
