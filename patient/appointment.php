...
<body>
    ...
    $sqlmain = "select b.appoid,a.scheduleid,a.title,doctor.docname,c.pname,a.scheduledate,a.scheduletime, b.apponum,b.appodate from schedule a inner join appointment b on a.scheduleid=b.scheduleid inner join patient c on a.pid=b.pid inner join doctor on a.docid=doctor.docid where a.pid=$userid ";
    ...
    if ($_POST) {
        ...
        if (!empty($_POST["sheduledate"])) {
            ...
            $sqlmain .= " and a.scheduledate='$sheduledate' ";
        };
    ...
    $sqlmain .= "order by b.appodate  asc";
    ...
    <div class="container">
        ...
        <tr class="menu-row">
            <td class="menu-btn menu-icon-calendar">
                <a href="agendarcita.php" class="non-style-link-menu">
