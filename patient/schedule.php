...
<body>
    ...
    $sqlmain = "select * from schedule a inner join doctor b on a.docid=b.docid   where a.scheduledate>='$today'  GROUP by a.scheduleid  order by a.scheduledate asc";
    $sqlpt1 = "";
    $insertkey = "";
    $q = '';
    $searchtype = "Cantidad ";
    if ($_POST) {
        ...
        if (!empty($_POST["search"])) {
            ...
            $sqlmain = "select * from schedule a inner join doctor b on a.docid=b.docid where a.scheduledate>='$today' and (b.docname='$keyword' or b.docname like '$keyword%' or b.docname like '%$keyword' or b.docname like '%$keyword%' or a.title='$keyword' or a.title like '$keyword%' or a.title like '%$keyword' or a.title like '%$keyword%' or a.scheduledate like '$keyword%' or a.scheduledate like '%$keyword' or a.scheduledate like '%$keyword%' or a.scheduledate='$keyword' ) order by a.scheduledate asc;";
            //echo $sqlmain;
            $insertkey = $keyword;
